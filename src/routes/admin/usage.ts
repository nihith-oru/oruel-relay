...
adminUsageRouter.get("/overview", async (_req, res) => {
...
adminUsageRouter.get("/requests", async (req, res) => {
...
adminUsageRouter.get("/deployments", async (req, res) => {
...
adminUsageRouter.get("/by-client", async (_req, res) => {
  const markupPercent = await getMarkupPercent();
  const factor = 1 + markupPercent / 100;
